...
mod ham {
    ...
    pub fn run_ast(ast: ast_operations::Expression, heap: &Mutex<Heap>) {
                ...
                op_codes::REFERENCE => {
                    ...
                    if ref_value.is_ok() {
                        ...
                        val = match ref_value.val_type {
                            ...
                            op_codes::STRING => downcast_val::<primitive_values::StringVal>(
        ...
        // Modify a variable
        let modify_var =
            |var_name: String, value: Box<dyn primitive_values::PrimitiveValueBase>| {
