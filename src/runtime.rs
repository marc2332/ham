...
use crate::ast::ast_operations::{
    BoxedValue, FnCallBase, ReferenceValueBase, ResultExpressionBase,
};
...
use crate::utils::primitive_values::{
    BooleanValueBase, Number, NumberValueBase, StringVal, StringValueBase,
};
                ...
                match reference_type {
                    ...
                    _ => (
                        ...
                        ast_operations::BoxedValue {
                            ...
                            value: Box::new(ast_operations::Reference::new(String::from(val))),
                        },
                    ),
                }
            } else {
